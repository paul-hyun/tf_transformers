...
def new_embedding(input_dim, output_dim, **kwargs):
    ...
    :return:
    """
    return tf.keras.layers.Embedding(input_dim, output_dim, **kwargs)
...
def new_dense(units, **kwargs):
    ...
    :return:
    """
    return tf.keras.layers.Dense(units, **kwargs)
...
class PositionWiseFeedForward(tf.keras.layers.Layer):
    ...
    def __init__(self, config, name="feed_forward"):
        ...
        self.W_1 = new_dense(config["d_ff"], activation=tf.nn.relu)
